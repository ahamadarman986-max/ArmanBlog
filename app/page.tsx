    ...
    <>
      <section className="container-page grid min-h-[calc(100vh-5rem)] items-center gap-12 py-12 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <div className="relative group flex flex-col gap-6">
          <div className="surface relative mx-auto aspect-[16/9] w-full max-w-xl overflow-hidden rounded-lg border border-black/10 dark:border-white/10 ring-1 ring-black/5 dark:ring-white/10 shadow-xl transition-all duration-500 group-hover:shadow-2xl group-hover:border-gold/30">
            <Image
              src="/arman.jpg"
          ...
          <div className="surface mx-auto w-full max-w-xl rounded-lg p-5 shadow-lg border border-black/5 dark:border-white/5 transition-transform duration-500 group-hover:-translate-y-1">
