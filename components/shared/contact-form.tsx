    ...
    <form action={submit} className="surface grid gap-4 rounded-lg p-6 sm:p-8">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <button 
          ...
          className="focus-ring inline-flex w-fit items-center gap-2 rounded-full border border-[#25D366]/30 bg-[#25D366]/10 px-5 py-3 text-sm font-semibold text-[#25D366] transition hover:bg-[#25D366]/20"
        >
