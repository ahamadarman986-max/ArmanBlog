    ...
    <form action={submit} className="surface grid gap-4 rounded-lg p-6 sm:p-8">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <button 
          ...
          className="focus-ring inline-flex w-full sm:w-fit justify-center items-center gap-2 rounded-full bg-ink px-5 py-3 text-sm font-semibold text-white transition hover:bg-gold disabled:opacity-70 dark:bg-white dark:text-ink"
        >
        ...
        <button 
          ...
          className="focus-ring inline-flex w-full sm:w-fit justify-center items-center gap-2 rounded-full bg-[#25D366] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#20ba5a] active:scale-95 shadow-sm hover:shadow-md"
        >
